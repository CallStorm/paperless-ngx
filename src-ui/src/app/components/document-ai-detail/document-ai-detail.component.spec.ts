...
import {
  DocumentAiDetailComponent,
  ZoomSetting,
} from './document-ai-detail.component'
...
describe('DocumentAiDetailComponent', () => {
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(DocumentAiDetailComponent)
  ...
  it('should load four tabs via url params', () => {
    ...
    expect(component.activeNavID).toEqual(5) // DocumentAiDetailNavIDs.Notes
  })
  ...
  it('should change url on tab switch', () => {
    ...
    fixture.detectChanges()
    expect(navigateSpy).toHaveBeenCalledWith(['documents', 3, 'chat', 'notes'])
  })
  ...
  it('should support next doc', () => {
    ...
    expect(routerSpy).toHaveBeenCalledWith(['documents', 100, 'chat', 'details'])
  })
  ...
  it('should call tryRenderTiff when no archive and file is tiff', () => {
    ...
    const tiffRenderSpy = jest.spyOn(
      DocumentAiDetailComponent.prototype as any,
      'tryRenderTiff'
    )
